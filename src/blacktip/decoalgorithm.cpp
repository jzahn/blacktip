...
namespace blacktip
{
	void DecoAlgorithm::calculate(const unsigned long millis,
                                  const double depth, const Mix &mix)
	{
        ...
        DecoAlgorithm::minutesRemaining = minutesRemaining;
        DecoAlgorithm::ceiling = ceiling;
        DecoAlgorithm::floor = floor;
        DecoAlgorithm::saturation = saturation;
	}
}
