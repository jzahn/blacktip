...
tests.o: test/tests.cpp
	g++ -std=c++14 -c test/tests.cpp

main.o: src/main.cpp
	g++ -std=c++14 -c src/main.cpp

blacktipexp.o: src/blacktipexp.h src/blacktipexp.cpp
	g++ -std=c++14 -c src/blacktipexp.cpp
